...
function adicionarCor(event){
  ...
  if(nomeCor.length < 3 || corHexadecimal.length < 7 || corHexadecimal.charAt == '#' ||  !regex.test(corHexadecimal)){
  ...
  return (
    <body>   
      <main className="checkpoint">
        <section className={formularioErro ? 'form-error' : ''} onSubmit={event => adicionarCor(event)}>
